package io.github.daihaowxg.springmetadata.springreading;
...
public class AnnotationMetadataDemoByASM {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 获取 MetadataReader
        MetadataReader metadataReader = readerFactory.getMetadataReader("io.github.daihaowxg.springmetadata.springreading.bean.MyBean");
